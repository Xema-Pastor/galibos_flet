import flet as ft
from componentes.mis_componentes import MiColumnaTabla
...
tabla_lim = ft.ResponsiveRow([
    ...
    tabla_38_lim_Sja2,
    tabla_39_lim_Sji2,
    tabla_40_lim_Sja1_ast,
    tabla_41_lim_Sji1_ast,
    tabla_42_lim_Sja2_ast,
    tabla_43_lim_Sji2_ast,
    tabla_44_lim_SVa1,
    tabla_45_lim_SVi1,
    tabla_46_lim_SVa2,
    tabla_47_lim_SVi2,
    ...
    tabla_70_lim_bobstVM_max_a,
    tabla_71_lim_hobstVM_con_a,
    tabla_72_lim_bobstVM_con_i,
    tabla_73_lim_hobstVM_max_i,
    tabla_74_lim_bobstVM_con_a,
    tabla_75_lim_hobstVM_max_a,
    tabla_76_lim_bobstV0_max_i,
    tabla_77_lim_hobstV0_con_i,
    tabla_78_lim_bobstV0_max_a,
    tabla_79_lim_hobstV0_con_a,
    tabla_80_lim_bobstV0_con_i,
    tabla_81_lim_hobstV0_max_i,
    tabla_82_lim_bobstV0_con_a,
    tabla_83_lim_hobstV0_max_a,
],
columns=35)
...
tabla_nom = ft.ResponsiveRow([
    ...
    tabla_84_nom_bobstVM_max_i,
    tabla_85_nom_hobstVM_con_i,
    tabla_86_nom_bobstVM_max_a,
    tabla_87_nom_hobstVM_con_a,
    tabla_88_nom_bobstVM_con_i,
    tabla_89_nom_hobstVM_max_i,
    tabla_90_nom_bobstVM_con_a,
    tabla_91_nom_hobstVM_max_a,
    tabla_92_nom_bobstV0_max_i,
    tabla_93_nom_hobstV0_con_i,
    tabla_94_nom_bobstV0_max_a,
    tabla_95_nom_hobstV0_con_a,
    tabla_96_nom_bobstV0_con_i,
    tabla_97_nom_hobstV0_max_i,
    tabla_98_nom_bobstV0_con_a,
    tabla_99_nom_hobstV0_max_a,
],
columns=35,)
